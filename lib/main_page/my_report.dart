  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Center(
        child: Column(
          children: [
            const Text("오늘의 섭취량", style: TextStyle(fontSize: 20)),
            const Text("Kcal", style: TextStyle(fontSize: 15)),
            LinearPercentIndicator(
              alignment: MainAxisAlignment.center,
              percent: getPercent(record.todayKcal, nutrition.kcal),
              lineHeight: 20,
              center: Text('${record.todayKcal}(${((record.todayKcal/nutrition.kcal)*100).toStringAsFixed(2)}%)'),
            ...
            LinearPercentIndicator(
              alignment: MainAxisAlignment.center,
              percent: getPercent(record.todayCarbohydrate, nutrition.carbohydrate),
              lineHeight: 20,
              center: Text('${record.todayCarbohydrate}(${((record.todayCarbohydrate/nutrition.carbohydrate)*100).toStringAsFixed(2)}%)'),
            ...
            LinearPercentIndicator(
              ...
              lineHeight: 20,
              center: Text('${record.todayProtein}(${((record.todayProtein/nutrition.protein)*100).toStringAsFixed(2)}%)'),
            ...
            LinearPercentIndicator(
              ...
              lineHeight: 20,
              center: Text('${record.todayFat}(${((record.todayFat/nutrition.fat)*100).toStringAsFixed(2)}%)'),
            ...
            itemBuilder: (BuildContext context, int index) {
              return Card(
                child: Column(
                  children: [
                    Text('${record.list[index]['date']}', style: const TextStyle(fontSize: 20)),
